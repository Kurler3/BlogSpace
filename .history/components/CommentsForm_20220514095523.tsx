...
const CommentsForm:React.FC<Props> = ({slug}) => {
  ...
  const handleCommentSubmittion = useCallback(() => {
    ...
    let comment = commentElement.current?.valueOf;
    let name = nameElement.current?.valueOf;
    let email = emailElement.current?.valueOf;
    let storeData = storeDataElement.current?.valueOf;
